defmodule TrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{complete: true, descr: "some descr", time_spent: 42, title: "some title"}
  @update_attrs %{complete: false, descr: "some updated descr", time_spent: 43, title: "some updated title"}
  @invalid_attrs %{complete: nil, descr: nil, time_spent: nil, title: nil}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated descr"
    end
